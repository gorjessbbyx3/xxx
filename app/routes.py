...
def export_check_pdf():
    ...
    return jsonify({
        "success": True,
        "message": "Check design exported as PDF",
        "download_url": f"/static/generated/check_{int(time.time())}.pdf"
    })
...
if __name__ == '__main__':
    ...
    create_directory('crawl_results')
    create_directory(os.path.join('app', 'static', 'generated'))
